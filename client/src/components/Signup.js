...
const uploadFields = ()=>{
  if (!/^[a-z\d]{5,30}$/i.test(name))         //look for regex(regular expression) javascript validation which checks for name , password , email to be valid
    {
...
const PostData = ()=>{
  ...
  return (
    ...
    <div className="cardComponent">
      ...
      <TextField id="standard-basic" style={{width:"30vw"}} label="name"
      value={name}
